    ...
    <section class="content">
      ...
      <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box" style="background-color: Red">
            <div class="inner" style="background-color:#3f719b ;color:black ; font-size:15px;" >
              <?php
            ...
            <a href="positions.php" class="small-box-footer " style="background-color:#002eff ; color:black ; font-size:18px">More info <i class="fa fa-arrow-right"></i></a>
          </div>
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="small-box bg-green">
            <div class="inner" style="background-color: 	#f9b051 ;color:black ; font-size:15px">
              <?php
        ...
        <div class="col-lg-3 col-xs-6" style=" font-family:Times">
          ...
          <div class="inner" style="background-color: #f1c2b0 ;color:black ; font-size:15px; font-family:Times">
              <?php
            ...
            <a href="voters.php" class="small-box-footer "style="background-color:  #635957 ;color:black ; font-size: 18px">More info <i class="fa fa-arrow-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
      ...
      <?php
        ...
        while($row = $query->fetch_assoc()){
          ...
          echo "
           ...
           <div class='col-sm-6'  > 
              <div class='box box-solid' style='background-color: #efcf73' >
                <div class='box-header with-border' style='background-color: #efcf73'>
                  <h4 class='box-title'><b>".$row['description']."</b></h4>
                </div>
                <div class='box-body' style='background-color: #efcf73'>
                  <div class='chart' style='background-color: #efcf73'>
