    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f3da93 ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-success btn-curve"style='background-color: #46bb37 ;color:black ; font-size: 12px; font-family:Times' tyle='background-color: #46bb37 ;color:black ; font-size: 12px; font-family:Times'  name="save"><i class="fa fa-save"></i> Save</button>
              </form>
            </div>
        </div>
    </div>
