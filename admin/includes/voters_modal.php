    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f3da93 ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn btn-primary btn-curve" style='background-color:  #46bb37  ;color:black ; font-size: 12px; font-family:Times' name="add"><i class="fa fa-save"></i> Save</button>
              </form>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="edit_photo">
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f3da93 ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
              <button type="button" class="btn btn-default btn-curve pull-left"style='background-color: #c18936  ;color:black ; font-size: 12px; font-family:Times' data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" class="btn btn-success btn-curve"style='background-color: #46bb37 ;color:black ; font-size: 12px; font-family:Times' name="upload"><i class="fa fa-check-square-o"></i> Update</button>
              </form>
            </div>
        </div>
    </div>
