    ...
    <div class="modal-dialog">
        <div class="modal-content" style="background-color: #f3da93 ;color:black ; font-size: 15px; font-family:Times ">
            ...
            <div class="modal-footer">
              ...
              <a href="votes_reset.php" class="btn btn-danger btn-curve"style='background-color:  #46bb37  ;color:black ; font-size: 12px; font-family:Times' ><i class="fa fa-refresh"></i> Reset</a>
            </div>
        </div>
    </div>
</div>