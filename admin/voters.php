      ...
      <div class="row">
        <div class="col-xs-12" >
          <div class="box" style="background-color: #ADB5BD">
            ...
            <a  href = "update_status.php"class = "btn btn-danger btn-outline pull-right" style = "margin-right:12px;" name = "go"><i class = "fa fa-asterisk fa-spin"></i> Inactivate</a>
            <a  href = "update.php"class = "btn btn-danger btn-outline pull-right" style = "margin-right:12px;" name = "go"><i class = "fa fa-asterisk fa-spin"></i> Activate</a>
