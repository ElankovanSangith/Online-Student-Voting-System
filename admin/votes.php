...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="background-color:#DEE2E6 ;color:black ; font-size: 17px; font-family:Times ">
        ...
        <div class="col-xs-12">
          <div class="box"style="background-color: #ADB5BD">
            <div class="box-header with-border"style="background-color: #ADB5BD">
              <a href="#reset" data-toggle="modal" class="btn btn-danger btn-sm btn-curve"  style="background-color: #2E8B57;color:black ; font-size: 12px; font-family:Times"><i class="fa fa-refresh"></i> Reset</a>
            </div>
            <div class="box-body">
