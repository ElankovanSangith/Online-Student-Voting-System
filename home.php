...
<div class="wrapper">
	...
	<?php include 'includes/navbar.php'; ?>
	  ...
	  <div class="content-wrapper" style="background-color: #bec2c5 ">
	    <div class="container" style="background-color: #bec2c5 ">
				        		...
				        		<?php
									...
									while($row = $query->fetch_assoc()){
										...
										while($crow = $cquery->fetch_assoc()){
											...
											$candidate .= '
												<li>
													'.$input.'<data-fullname="'.$crow['firstname'].' '.$crow['lastname'].'"><img src="'.$image.'" height="100px" width="100px" class="clist"><span class="cname clist">'.$crow['firstname'].' '.$crow['lastname'].'</span>
												</li>
											';
										}
										...
										echo '
											<div class="row">
												<div class="col-xs-12">
													<div class="box box-solid" style="background-color: #ffffff" id="'.$row['id'].'">
														<div class="box-header with-border" style="background-color: #ffffff">
